...
![codex下載](./images/download-codex01.png)

安裝程式可能會將你帶到 Microsoft Store，接著由 Microsoft Store 自動下載並安裝 ChatGPT 桌面 App。

安裝完成後，從 Windows 開始選單搜尋 `ChatGPT`

![codex下載](./images/download-codex03.png)
...
![codex下載](./images/download-codex02.png)
...
這些 Plugin 之後仍然可以重新安裝，因此本次課程先點擊畫面下方的 Skip
...
![alt text](./images/download-codex06.png)

---

## 在專案中建立對話

在左側專案名稱旁，可以看到建立一個鉛筆符號
...
若想讓 AI Agent 協助執行某個不屬於任何專案，並且偏向於單次性的任務，未來不需要長期協作的專案，可以做左側面板中選擇任務功能，來打開對話窗
